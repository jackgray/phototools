...
E = float(float(R) / 8)   # Enlargement Latitude
...
min_lppmm = input('Target resolution in lp/mm?')

print_scan_res_x = int(min_lppmm) * E_x
print_scan_res_y = int(min_lppmm) * E_y
print_scan_res_hyp = int(min_lppmm) * E_hyp
